...
|---|---|---|
| `rtorrent-0.16` | 0.16.23 | 2.34 |
| `rtorrent-0.9.8` | 0.9.8 | 2.17 |
| `rtorrent-master` | `80ae6a4590df` (git) | 2.34 |
...
| `qbittorrent-master-lt-mater` | `9b0e9311f3e8` (git) | 2.34 |
...
| `0.16.23.amd.v1` | x86_64-v1 |
| `0.amd.v3` | x86_64-v3 |
| `0.16.amd.v3` | x86_64-v3 |
| `0.16.23.amd.v3` | x86_64-v3 |
